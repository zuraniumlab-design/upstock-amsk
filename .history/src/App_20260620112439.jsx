    ...
    <div className={styles.container}>
      ...
      <div className={styles.content}>
        <div className={styles.head}>
          <button className={styles.addItem} onClick={() => setAddItem(true)}>
            <Plus />
            
            {
              addItem ? <input type="text" onInput={(e) => setItemName(e.target.value)} autoFocus /> : <div className={styles.addItemLabel}>Add Product</div>
            }
          </button>
