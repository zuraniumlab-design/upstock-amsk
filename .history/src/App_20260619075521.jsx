...
import { Plus, Search, Trash, Trash2, Trash2Icon } from "lucide-react";
            ...
            return (
              <div key={key[0] + "-" + index} className={styles.item}>
                <div className={styles.topItem}>
                  ...
                  <button className={styles.addWeight} title="Add Weight" onClick={() => handleAddWeight(index)}>
                    <Plus size={16}/>
                  </button>
                </div>
